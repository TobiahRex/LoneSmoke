...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports.sesDiscountHandler = function (event, context) {
	  ...
	  if (!event.body.userEmail || !event.body.type) context.error && context.error((0, _extends3.default)({ type: 'ERROR', problem: 'Missing required arguments!' }, event.body));
	  ...
	  (0, _connection2.default)().then(function (dbResults) {
	    ...
	    context.error && context.error((0, _extends3.default)({ message: 'Ses Discount handler FAILED' }, error));
	  });
	};
	...
	module.exports.sesStatusHandler = function (event, context) {
	  ...
	  (0, _connection2.default)().then(function (dbResults) {
	    ...
	    console.log('\nFINAL Lambda ERROR: \n', (0, _stringify2.default)(error, null, 2));
	    context.error && context.error((0, _extends3.default)({ message: 'Ses Status handler FAILED' }, error));
	  });
	};
	...
	exports.default = function (_ref) {
	  ...
	  return new _promise2.default(function (resolve, reject) {
	    ...
	    MarketHero.checkForLead(userEmail).then(function (dbUser) {
	      // eslint-disable-line
	      if (dbUser) {
	        Email.findEmailAndFilterLanguage(type, language).then(function (filteredEmail) {
...
/***/ (function(module, exports) {
	...
	module.exports = {
		"aws": {
			"accessKeyId": "AKIAJ5IDJPMRRECWPAUQ",
			"secretAccessKey": "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",
